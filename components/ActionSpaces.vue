...
<template>
  <div class="flex gap-5 p-3">
    <div v-for="action in store.builtSpaces" :key="action.name" @click="store.takeAction(action)" class="flex flex-col items-center border-2 border-yellow-500 bg-yellow-100 rounded-lg shadow-md p-1 hover:bg-yellow-50">
